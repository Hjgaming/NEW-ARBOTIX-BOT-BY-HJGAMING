...
module.exports = {
  ...
  const embed = new MessageEmbed()
    ...
    const done = new MessageEmbed()
       .setDescription(`<a:verifie:792385094034915330>  | Your suggestion is Submitted here, <#${channel}>\n\nNote: You agreed to get a DM on a reply over your Suggestion!`)
       .setColor("00FFFF")
    ...
    await msgEmbed.react('<a:verifie:792385094034915330>')
    await msgEmbed.react('<a:v_wrong:874707273296007228>')
  }
}