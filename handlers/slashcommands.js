...
//client.api.applications(client.user.id).guilds('guild id').commands.post({data: {     für einen server VVVV ist für mehr als 1 server
	...
	.setDescription(`[<a:GIFHUB:798646097702420511> INVITE ME NOW, thanks](https://discord.com/api/oauth2/authorize?client_id=789845410998779904&permissions=8&scope=bot%20applications.commands)
        
        [<:musicium:775854849970798632> INVITE MUSICIUM](https://dc.musicium.eu)
        
        [<:ChannelMaster:778404076466602024> INVITE CHANNEL MASTER](https://ch.musicium.eu)
           |   [\`Website\`](https://musicium.eu)   |   :heart: Thanks for inviting!`)
	.setFooter(client.user.username + " | Syntax:  <>...must    []...optional", client.user.displayAvatarURL())
	.setAuthor(interaction.member.user.username,  client.user.displayAvatarURL(), "https://musicium.eu")
	let totalMembers = client.guilds.cache.reduce((c, g) => c + g.memberCount, 0);
            ...
            const infoembed = new Discord.MessageEmbed()
                .setAuthor(
                    ...
                    client.user.displayAvatarURL(), "https://discord.com/api/oauth2/authorize?client_id=789845410998779904&permissions=8&scope=bot%20applications.commands"
                )
                .setColor(config.colors.yes)
                .addFields(
                    {
            ...
            `)
                .addField("***SUPPORT:***", `
            >>> [\`Server\`](https://discord.gg/JtHCfTMem2) | [\`Musicium - Website\`](https://musicium.eu) | [\`Invite\`](https://discord.com/api/oauth2/authorize?client_id=789845410998779904&permissions=8&scope=bot%20applications.commands/)
            `)
            ...
            .setTitle(`Help Menu\nPrefix: \`${prefix}\``)
                ...
                *more coming soon*
                ...
                >>> <@442355791412854784> \`Tomato#6966\` [\`Website\`](https://musicium.eu) [\`INVITE\`](https://discord.com/api/oauth2/authorize?client_id=789845410998779904&permissions=8&scope=bot%20applications.commands)
                `)
        ...
        const info = client.categories
            ...
            helpembed.setDescription(info.substr(0, 1900)+ `... to see all cmds, type: \`${prefix}help\``);
        if(command == 'help') {
...
async function createAPIMessage(interaction, content) {
 ...
 console.log('Loaded Slash Commands'.brightGreen);
}