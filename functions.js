...
module.exports = {
    ...
    embedbuilder: function (client, deletetime, message, color, title, description, thumbnail) {
        ...
        try {
            let embed = new Discord.MessageEmbed()
                .setColor(color)
                .setAuthor(message.author.tag , message.member.user.displayAvatarURL({ dynamic: true }), "https://discord.gg/Zn83GvJr5H")
    ...
    playsongyes: async function(client, message, queue, song) {
        try {
            ...
            .setFooter(client.user.username, client.user.displayAvatarURL())
            .setAuthor(message.author.tag , message.member.user.displayAvatarURL({ dynamic: true }), "https://discord.gg/WJHvZBTBhZ")
            .setThumbnail(song.thumbnail)
